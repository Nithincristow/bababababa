...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('💠 ᴄʜᴀɴɴᴇʟ 💠', url='https://t.me/BANSHEE2003'),
            InlineKeyboardButton('💠 ᴜᴘᴅᴀᴛᴇs 💠', url='https://t.me/televisionmarket')
            ],[      
            InlineKeyboardButton('♻️ ʜᴇʟᴘ ♻️', callback_data='help'),
            InlineKeyboardButton('♻️ ᴀʙᴏᴜᴛ ♻️', callback_data='about')
            ],[
            InlineKeyboardButton('✅ 🐽ᴛᴇʟᴇᴠɪsɪᴏɴ ᴍᴀʀᴋᴇᴛ🐽  ✅', url='https://t.me/televisionmarket')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons= [[
            InlineKeyboardButton('♥️ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙾𝙳𝙴 ♥️', url='https://t.me/televisionmarket')
            ],[
